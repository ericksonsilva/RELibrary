 ...
 * @author Erickson
 */
public class ExibirLivro extends javax.swing.JInternalFrame {
    
    public ExibirLivro(Livro l) {
    ...
    public void offCampos(){
        c_Titulo.setEditable(false);
        c_Autor.setEditable(false);
        c_Edicao.setEditable(false);
        c_Ano.setEditable(false);
        c_Editora.setEditable(false);
        c_Inf.setEditable(false);
        c_Registro.setEditable(false);
        c_Data.setEnabled(false);
        cb_Biblioteca.setEnabled(false);
        c_Registro.setEditable(false);
    }
