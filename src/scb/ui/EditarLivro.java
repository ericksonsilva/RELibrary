...
public class EditarLivro extends javax.swing.JInternalFrame {
    ...
    public EditarLivro(Livro l) {
        ((javax.swing.plaf.basic.BasicInternalFrameUI) this.getUI()).setNorthPane(null);
        initComponents();
        this.setLocation(Util.gerarPosicao(this.getSize()));
        listarLivros = ListarLivros.getInstance();
    ...
    public void salvarLivro(){
        new File(Util.dirImageLoad("books", l.getRegistro())).delete();        
        Livro l = new Livro();
        ...
        try {
            facade.editarLivro(l);
            JOptionPane.showMessageDialog (null, "Livro atualizado com sucesso.", "Operação concluída", JOptionPane.INFORMATION_MESSAGE);  
            
        } catch (SCBFacadeException ex) {
            JOptionPane.showMessageDialog (null, "Falha ao atualizar livro.", "Operação concluída", JOptionPane.INFORMATION_MESSAGE);              
            Logger.getLogger(EditarCadastro.class.getName()).log(Level.SEVERE, null, ex);
        }
        listarLivros.atualizarTabela(l);
        String out = Util.dirImageSave("books", l.getRegistro()); 
        Util.copyfile(imgPanel.getImage(), out);
    }
    
    public void setCamposLivro(){
        c_Titulo.setText(l.getTitulo());
        c_Autor.setText(l.getAutor());
        c_Edicao.setText(l.getEdicao());
        c_Ano.setText(String.valueOf(l.getAno()));
        c_Editora.setText(l.getEditora());
        c_Inf.setText(l.getInf());
        c_Registro.setText(String.valueOf(l.getRegistro()));
        c_Data.setDate(l.getData());
        cb_Biblioteca.setSelectedItem(l.getBiblioteca());
        c_Registro.setEnabled(false);
        if (!(new File(Util.dirImageLoad("books", l.getRegistro()))).exists()) {
                setJImagePanel(Util.getDirLiv());
        }else{
            setJImagePanel(Util.dirImageLoad("books", l.getRegistro()));
        }   
    }
    ...
    private void initComponents() {
        ...
        l_Titulo.setText("Cadastramento de livros");
    ...
    private void setJImagePanel(InputStream dirLiv) {
