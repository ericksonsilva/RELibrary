...
public class EditarUsuario extends javax.swing.JInternalFrame {
    ...
    public EditarUsuario(Usuario u) {
        ...
        initComponents();
        listarUsuarios = ListarUsuarios.getInstance();
    ...
    public void salvarUsuario(){
       ...
       u.setSenha(String.valueOf(c_Senha.getPassword()));
        try {
            ...
            JOptionPane.showMessageDialog (null, "Usuário atualizado com sucesso.", "Operação concluída", JOptionPane.INFORMATION_MESSAGE);  
            
        } catch (SCBFacadeException ex) {
            JOptionPane.showMessageDialog (null, "Falha ao atualizar usuário.", "Operação concluída", JOptionPane.INFORMATION_MESSAGE);              
            
            Logger.getLogger(EditarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
        listarUsuarios.atualizarTabela(u);
    ...
    public void setCamposUsuario(){
        ...
        cb_Turno.setSelectedItem(u.getTurno());
        c_Telefone.setText(u.getTelefone());
